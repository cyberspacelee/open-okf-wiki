...
Incremental reuse stays narrow: triage, survey and source-owned plan shards
require that Source's commit; connect and workspace plan require all
Git/files commits and catalogs; pages require an identical Page Plan entry,
unchanged cited Git blob IDs and an unexpired stale_after. Live HEAD may move;
workers read Pins (ADR 0011). No generic dependency graph is kept.

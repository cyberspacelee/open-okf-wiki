...
`source/path#Lx-Ly`. Git and PostgreSQL remain. Remote wikis
(Confluence/SharePoint) are out of scope: they need credentials and a
fetch/refresh story this kernel does not own.

...
def parser() -> argparse.ArgumentParser:
    ...
    wiki_run_command.add_argument("--source-files-limit", type=int)
    wiki_run_command.add_argument("--source-file-bytes-limit", type=int)
    wiki_run_command.add_argument("--source-total-bytes-limit", type=int)
    wiki_run_command.add_argument("--wiki-entries-limit", type=int)

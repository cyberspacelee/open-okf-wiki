"""Staging acceptance: Host-owned change assessment after Complete.
...
class StagingChangeAssessment:
    """Host-owned Staging vs prior Published Wiki assessment."""
...
def assess_staging_changes(
    *,
    ...
    """Compute page digests and the Host-owned WikiChangeSummary."""

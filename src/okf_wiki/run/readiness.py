"""Run readiness: volumes, publication lock, Refresh stage-in, Snapshot freeze.

One deep entry for "make this Wiki Run run-ready" so lifecycle does not
...
@dataclass
class RunReadiness:
    """Locked, frozen run environment ready for the Semantic Workflow agent.
    ...
    def __enter__(self) -> RunReadiness:
        return self
...
def open_run_readiness(
    ...
    *,
    ...
    Caller must :meth:`RunReadiness.close` (or use as a context manager).
    """

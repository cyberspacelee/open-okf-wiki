"""Portable filesystem policy (ADR 0017).

Public façade for path-component safety and atomic single-file handoffs.
Path-walk implementation lives in :mod:`okf_wiki.run.mounts` (publication
layout + locks); this module is the run-facing import surface and the home of

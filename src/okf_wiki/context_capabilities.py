...
emits compaction_warning / compaction_completed when deps support the Host event
...
class CompactionEventDeps(Protocol):
    """Minimal Host deps surface for compaction observation events."""
...
class ObservableTieredCompaction(TieredCompaction[Any]):
    """TieredCompaction with optional Host compaction_warning / completed events.

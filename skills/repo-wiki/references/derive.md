...
Run a proposed Verify command in that Source before including it. Do not claim
a failed or unavailable command was verified. Omit Verify when no meaningful
command can run.

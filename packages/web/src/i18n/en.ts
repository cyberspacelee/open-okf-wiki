export const en = {
  ...
  agentWorkspace: {
    ...
    emptyDescription:
      "Message the agent, or start a wiki run. Tools, work units, and gates appear on this timeline.",
    ...
    gatePublish: "Publish",
    thinking: "Reasoning",
    thinkingStreaming: "Reasoning…",
    /** Empty running work unit (no message/tools yet) — never "Thinking". */
    waitingForEvents: "Waiting for events…",
    waitingForUnits: "Waiting for units…",
    workBlockTitle: "Wiki work",
    workRunningCount: "{n} running",
    workFailedCount: "{n} failed",
    ...
    modeChat: "Chat",
    modeWikiRun: "Wiki run",
    domains: "Domains",
    planJumpToGate: "Actions are on the timeline gate card.",
    productCopy: {
      working: "Working",
      ...
      runLinkStatus: "Linked job {id} · {status}",
      writingPages: "Writing pages {done}/{total}",
      pagesMore: "… +{n} more",
      defectsClean: "Review passed (round {round})",
      defectsFound: "Review found {count} issue(s) (round {round})",
    },
    roles: {
      planner: "Planner",
      plan: "Planner",
    ...
    phases: {
      idle: "Ready",
      planning: "Planning",
      awaiting_plan: "Needs plan OK",
      writing: "Writing",
      producing: "Writing",
      awaiting_publish: "Needs publish OK",
      awaiting_publication: "Needs publish OK",
      done: "Done",
      published: "Done",
      failed: "Failed",
      cancelled: "Cancelled",

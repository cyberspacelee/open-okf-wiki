export const en = {
  ...
  detail: {
    ...
    ctaOpenSession: "Open Agent Workspace",
    ctaOpenWiki: "Browse wiki",
    statusSourcesTitle: "Sources",
    statusSourcesEmpty: "None yet — link a Git checkout to generate a wiki.",
    statusModelTitle: "Model",
    statusWikiTitle: "Wiki language",
    statusPublicationTitle: "Publication path",
  },
  settings: {
  ...
  session: {
    ...
    /** Wiki-run phase labels (data-progress). */
    phase: {
      idle: "Idle",
      planning: "Planning",
    ...
    tools: {
      ...
      advancedRaw: "Advanced raw",
      truncatedPreview: "Preview truncated",
      pagesWritten: "{written}/{total} pages written",
      reviewClean: "Review council: clean",
      reviewDefects: "Review council: {n} defect(s), {blocking} blocking",
      reviewRound: "round {n}",
      batchListedDirs: "Listed {n} directories",
      batchReadSources: "Read {n} source files",
      batchListedSkill: "Listed skill {n}×",
      batchReadSkill: "Read {n} skill files",
      batchListedWiki: "Listed wiki {n}×",
      batchReadWiki: "Read {n} wiki pages",
      batchGeneric: "{name} × {n}",
    },
  },
  runs: {
    ...
    title: "Jobs",
    descriptionBefore:
      "Job audit for Wiki Runs: list status, cancel, and retry. Interactive generate, plan negotiation, and publish decisions live on ",
    ...
    advancedHint: "Headless start and job audit controls without Session chat.",
    ...
    working: "Working…",
    decline: "Decline",
    /** Job console is read-mostly; HITL lives on Session (ADR 0026). */
    gateOnSessionPlan:
      "This job is waiting for a plan decision. Approve, revise, or deny in Session.",
  ...
  wiki: {
    ...
    emptyDescription:
      "No markdown pages were found under the publication path. Generate a wiki in Session and approve publication to populate this view.",
    goToSession: "Generate in Session",
    pages: "Pages",
  ...
  agentWorkspace: {
    ...
    panelRun: "Run",
    openFull: "Open",
    sourcesEmpty: "No sources linked. Add a Git checkout to generate a wiki.",
    publicationPath: "Publication path",
    wikiLanguage: "Wiki language",
    wikiHint: "Browse published pages from the full Wiki view.",

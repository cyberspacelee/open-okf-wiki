...
export const zh: MessageTree = {
  ...
  agentWorkspace: {
    ...
    waitingForUnits: "等待工作单元…",
    workBlockTitle: "Wiki 工作",
    workRunningCount: "{n} 个运行中",
    workFailedCount: "{n} 个失败",
    workProgressDone: "{done}/{total} 已完成",
    jumpToLatest: "跳到最新",
    viewSubagent: "查看输出",
    subagentPreviewHint: "工作单元预览（规划 / Domain / Leaf / 审查）。",
    subagentNoDetail: "该单元尚无详细输出。",
    agentTreeTitle: "代理",
    agentTreeEmpty: "尚无工作单元。启动 Wiki Run 后可看到规划 / 研究单元。",
    agentTreeNoRun: "尚未关联 Run — 启动 Wiki Run 后填充代理树。",
    agentTreeLoading: "加载 receipt…",
    modeChat: "对话",
    modeWikiRun: "Wiki 运行",
    domains: "域",
    planJumpToGate: "操作在时间线的门控卡片上。",
    productCopy: {
      working: "处理中",
      withDetail: "{head} — {detail}",
      gatePlan: "计划已就绪。请在下方批准、修订或拒绝。",
      gatePlanPages: "计划已就绪 — {n} 个页面。请在下方批准、修订或拒绝。",
      gatePublish: "Wiki 已就绪，可发布。请在下方批准或拒绝。",
      gateInput: "需要输入",
      runLink: "已关联任务 {id}",
      runLinkStatus: "已关联任务 {id} · {status}",
      writingPages: "正在写入页面 {done}/{total}",
      pagesMore: "… 另有 {n} 个",
      defectsClean: "审查通过（第 {round} 轮）",
      defectsFound: "审查发现 {count} 个问题（第 {round} 轮）",
    },
    roles: {
      planner: "规划",
      plan: "规划",

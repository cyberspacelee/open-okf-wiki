...
export const MessageContent = ({
  ...
  <div
    className={cn(
      // Assistant: full row width so tool cards get a fixed containing block
      // (w-fit + long CodeBlock/pre was expanding the whole conversation).
      // User: keep bubble w-fit.
